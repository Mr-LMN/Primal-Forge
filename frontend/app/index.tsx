...
import {
  ...
  FOCUS_META, XP_RULES, CREDIT_PER_XP, PERKS,
    ...
    <SafeAreaView style={styles.root} edges={["top", "bottom"]}>
      ...
      <View style={styles.shell}>
        ...
        <View style={{ flex: 1 }}>
          ...
          {tab === "forge" && (
            <ForgeView onLogWorkout={handleWorkoutLog} loggedToday={workoutsLogged.filter((w) => w.date === todayKey())} />
          )}
          {tab === "scan" && <ScanView />}
          {tab === "vault" && (
            <VaultView
...
/* =========================================================
   FORGE VIEW
   ========================================================= */
function ForgeView({ onLogWorkout, loggedToday }: {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.scrollPad} testID="forge-view">
        ...
        {filtered.length === 0 && (
          <View style={styles.emptyBox}><Text style={styles.emptyText}>No workouts match. Loosen the filter.</Text></View>
        )}
